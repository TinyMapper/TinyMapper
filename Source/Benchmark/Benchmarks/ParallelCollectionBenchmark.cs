...
{
    public sealed class ParallelCollectionBenchmark : Benchmark
    {
        private const int CollectionLength = 100;

        public ParallelCollectionBenchmark(int iterations) : base(iterations)
        {
        }
        ...
        {
            return string.Format("CollectionLength: {0} as Parallel", CollectionLength);
        }
