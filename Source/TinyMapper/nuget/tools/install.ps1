...
try
{
  $url = "http://tinymapper.net/"
  $packageName = "tinymapper"
  ...
  if ($dte2.ActiveWindow.Caption -eq "Package Manager Console")
  {
    ...
    # show webpage if "install-package TinyMapper" was last input
  ...
  else
  {
    ...
    # show webpage if messages in buffered console contains "installing...TinyMapper" in last operation
